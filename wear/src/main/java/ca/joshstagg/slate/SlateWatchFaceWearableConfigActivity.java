...
/**
 * The watch-side config activity for {@link SlateWatchFaceService}, which allows for setting the
 * second hand color.
 */
public class SlateWatchFaceWearableConfigActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slate_config);
        ...
        String[] names = getResources().getStringArray(R.array.color_array_names);
        listView.setAdapter(new ColorListAdapter(colors, names));
    ...
    private void updateConfigDataItem(final int color) {
        DataMap configKeysToOverwrite = new DataMap();
        configKeysToOverwrite.putInt(SlateWatchFaceUtil.KEY_SECONDS_COLOR, color);
    ...
    private class ColorListAdapter extends WearableListView.Adapter {
        ...
        public ColorListAdapter(String[] colors, String[] names) {
            mColors = colors;
            mNames = names;
        }
        ...
        public void onBindViewHolder(WearableListView.ViewHolder holder, int position) {
            ...
            colorItemViewHolder.mColorItem.setColor(color, name);
    ...
    private static class ColorItem extends LinearLayout implements
        ...
        private void setColor(String color, String name) {
            mLabel.setText(name);
